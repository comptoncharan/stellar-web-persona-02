      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
            ...
            Bringing 15+ years of leadership experience to software development.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button 
              size="lg" 
              className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 rounded-full transition-all duration-300 hover:scale-105 glow-effect group"
              asChild
            >
              <a href="#projects">
                View My Work
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 border-border hover:border-primary hover:bg-primary/10 px-8 py-6 rounded-full transition-all duration-300 hover:scale-105"
            >
